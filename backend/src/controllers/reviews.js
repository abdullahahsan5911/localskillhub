...
export const createReview = async (req, res, next) => {
  try {
    ...
    // Recalculate comprehensive reputation (overall/local/skill trust) based on this new review
    try {
      await ReputationService.recalculateReputation(review.reviewedUserId);
    } catch (reputationErr) {
      console.error('Failed to recalculate reputation after review:', reputationErr?.message || reputationErr);
      // Do not block review creation if reputation calculation fails
    }
