            ...
            <div className="flex gap-2">
              {[Twitter, Linkedin, Github].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="flex h-9 w-9 items-center justify-center rounded-md bg-white/5 text-background/40 hover:text-background hover:bg-white/10 transition-colors duration-200"
                >
